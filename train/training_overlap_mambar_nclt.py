...
class trainHandler():
    def __init__(self, height=32, width=900, channels=5, norm_layer=None, lr=0.001,
        ...
        self.resume = False
        self.save_name = "/home/robot/下载/OverlapTransformer-master-copy/weights/nclt_noimloss/trained_overlap_transformer4.pth.tar"
    ...
    def train(self):
        ...
        writer1 = SummaryWriter(comment="LR_0.xxxx", log_dir="test_device")
        ...
        for i in range(starting_epoch + 1, epochs):
            ...
            for j in range(len(self.train_imgf1)):
                ...
                # inputbatch = torch.cat((current_batch, shift_batch1), dim=0)
                # inputbatch1 = torch.cat((inputbatch, shift_batch2), dim=0)
                # input_batch = torch.cat((inputbatch1, sample_batch), dim=0)
                ...
                input_batch_shift = shift(input_batch, 3, index)
                ...
                o1, o2, o3 = torch.split(
                    global_des_add, [1, pos_num, neg_num], dim=0)
                MARGIN_1 = 0.5
                """
            ...
            self.save_name = "../weights/nclt_cvtnet/trained_overlap_transformer" + str(i) + ".pth.tar"
            ...
            print("Model Saved As " + 'trained_overlap_mamba' + str(i) + '.pth.tar')
