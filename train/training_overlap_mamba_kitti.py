...
class trainHandler():
    def __init__(self, height=64, width=900, channels=5, norm_layer=None, lr = 0.001,
        ...
        self.resume = False
        self.save_name = "../weights/shift_bimamba_sppf_80/trained_overlap_transformer19.pth.tar"
    ...
    def train(self):
        ...
        for i in range(starting_epoch+1, epochs):
            ...
            print("Model Saved As " + 'trained_overlap_transformer' + str(i) + '.pth.tar')
...
if __name__ == '__main__':
    ...
    """
    train_handler = trainHandler(height=64, width=900, channels=1, norm_layer=None, lr=0.000005,
